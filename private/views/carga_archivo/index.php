...
if (isset($_GET['mensaje'])=='exito') {
  echo '  <script type="text/javascript">alert("REGISTRO EXITOSO"); $(location).attr("href","?view=carga_archivo&mode=index");</script>';
}
?>
	<div class="row">
	      	...
	      	<div class="panel panel-default">
	        	<div class="panel-body">
	          		<div class="form-group">
						...
						<br>
						<form id="formulario" onsubmit="return validacion();" action="?view=carga_archivo&mode=registro" method="POST" class="form-horizontal" enctype="multipart/form-data">
										<center>
							<div class="form-row">
