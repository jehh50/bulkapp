...
function agregarproducto(){
  $('#productosS').append('<div id="productosS'+conS+'"><br><div class="row"><div class="col-lg-4"><input type="text" class="form-control" name="producto[]" placeholder="PRODUCTO I" onkeyup="mayus(this);" required></div><div class="col-lg-3"><input type="text" class="form-control" name="codigo[]" placeholder="025" onkeyup="mayus(this);" required></div><div class="col-lg-2"><input type="text" class="form-control" name="costo[]" placeholder="12345.67" onkeyup="mayus(this);" required></div><div class="col-lg-2"><input type="text" class="form-control" name="plan[]" placeholder="54A" onkeyup="mayus(this);" required></div><a title="Quitar Producto" id="quitarProductos" class="btn btn-default btn-sm glyphicon glyphicon-minus" onclick="quitarProductos('+conS+')"></a></div></div><br>')
      conS++
}
...
if (isset($_GET['mensaje'])=='exito') {
  ...
  echo '  <script type="text/javascript">alert("REGISTRO EXITOSO"); $(location).attr("href","?view=configuracion&mode=consultarProducto");</script>';
}
?>
                  ...
                  <div id="productosS">
                    <div class="row">
                      <div class="col-lg-4">
                        ...
                        <input type="text" class="form-control" name="producto[]" id="producto" placeholder="PRODUCTO I" onkeyup="mayus(this);" required>
                      </div>
                      <div class="col-lg-3">
