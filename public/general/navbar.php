            ...
            <?php } if($_SESSION['usertype_id'] == 2){?>   
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="?view=carga_archivo&mode=liberarCuotas">Liberar cuotas Cashea</a></li>
                  <li role="separator" class="divider"></li>
            ...
            <?php if($_SESSION['usertype_id'] == 2){?>
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="?view=reportes&mode=liberar">Liberar clientes Banca</a></li>
                  <li><a href="?view=xml&mode=index">Generar XML</a></li>
                  <li role="separator" class="divider"></li>
